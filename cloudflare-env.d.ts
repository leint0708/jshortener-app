/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 4843cb82b67f9b01bb96d1c009bddc6c)
// Runtime types generated with workerd@1.20251210.0 2025-12-01 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NEXTJS_ENV: string;
		DB: D1Database;
		JSHORTENER_RATE_LIMITER: RateLimit;
		WORKER_SELF_REFERENCE: Fetcher /* jshortener-app */;
